...
/**
 * @ClassName: ViewHistoryMineAdapter
 * @Description:
 * @Author: 常利兵
 * @Date: 2024/4/14 0014 13:15
 **/
class ViewHistoryMineAdapter(val mContext: Context) : AppAdapter<DJXDrama>(mContext) {
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): AppViewHolder {
        return ViewHolder()
    }

    inner class ViewHolder : AppViewHolder(R.layout.item_view_history_mine) {
